...
class SlicePredicate:
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'ignore_empty_rows', None, False, ), # 3
  )

  def __init__(self, column_names=None, slice_range=None, ignore_empty_rows=thrift_spec[3][4],):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.ignore_empty_rows = iprot.readBool();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.slice_range != None:
      ...
      oprot.writeFieldEnd()
    if self.ignore_empty_rows != None:
      oprot.writeFieldBegin('ignore_empty_rows', TType.BOOL, 3)
      oprot.writeBool(self.ignore_empty_rows)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()

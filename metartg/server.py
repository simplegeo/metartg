...
RRD_LGRAPH_DEFS = {
    ...
    'elasticsearch-memory': [
        ...
        'GPRINT:heap_used:Max\\:  %%8.0lf %%sB',
        'GPRINT:heap_used:95th\\: %%8.0lf %%sB\\c',
        'AREA:nonheap_used#009966:nonheap used     \\l:STACK',
        'GPRINT:nonheap_used:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used:Max\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used:95th\\: %%8.0lf %%sB\\c',
        'LINE:heap_committed#FFFFFF:heap committed   \\l',
        'GPRINT:heap_committed:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed:Max\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed:95th\\: %%8.0lf %%sB\\c',
        ...
        'GPRINT:nonheap_committed:Max\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_committed:95th\\: %%8.0lf %%sB\\c',
    ],
}

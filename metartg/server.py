...
RRD_LGRAPH_DEFS = {
    ...
    'elasticsearch-memory': [
        ...
        'GPRINT:heap_used:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:heap_used:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:heap_used_max:Max\\:  %%8.0lf %%sB',
        'GPRINT:heap_used_95th:95th\\: %%8.0lf %%sB\\c',
        'AREA:nonheap_used#009966:nonheap used     \\l:STACK',
        'GPRINT:nonheap_used:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used_max:Max\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_used_95th:95th\\: %%8.0lf %%sB\\c',
        'LINE:heap_committed#FFFFFF:heap committed   \\l',
        'GPRINT:heap_committed:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed_max:Max\\:  %%8.0lf %%sB',
        'GPRINT:heap_committed_95th:95th\\: %%8.0lf %%sB\\c',
        'LINE:nonheap_committed#FFFFFF:nonheap committed\\l:STACK',
        'GPRINT:nonheap_committed:LAST:Cur\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_committed:AVERAGE:Avg\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_committed_max:Max\\:  %%8.0lf %%sB',
        'GPRINT:nonheap_committed_95th:95th\\: %%8.0lf %%sB\\c',
    ],
}
